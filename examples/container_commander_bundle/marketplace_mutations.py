...
def _marketplace_dir():
    return os.environ.get("MARKETPLACE_DIR", "/app/data/marketplace")
...
def export_bundle(blueprint_id):
    ...
    filepath = os.path.join(_marketplace_dir(), filename)
    meta = {
    ...
    with tarfile.open(filepath, "w:gz") as tar:
        ...
        _add_string_to_tar(tar, "README.md", f"# {detail.get('name', blueprint_id)}\n\n{detail.get('description', '')}\n")
    return filename
