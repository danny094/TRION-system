...
def get_starters() -> list[dict[str, Any]]:
...
def _normalize_health_profile(raw: dict[str, Any]) -> dict[str, int]:
...
def _normalize_catalog_entry(raw: dict[str, Any], raw_base: str) -> dict[str, Any]:
...
def _save_catalog_cache(payload: dict[str, Any]) -> None:
